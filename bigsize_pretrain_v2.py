...
def main(path):
    ...
    net = models_mae.mae_vit_base_patch16_dec512d8b(img_size=448)
    print(net)
    net.to(device)
    # lr = 1.5625e-3
    lr = 1e-4
    ...
    optimizer = optim.AdamW(net.parameters(), lr=lr, betas=(0.9, 0.95))
    ...
    check_flag = False
    if check_flag:
        check_point = torch.load('checkpoint/500.pth', map_location=device)
